...
namespace CarRental.Contract_Payment_Scheduling_Applications
{
    public partial class frmListOfSchedulingApplication : Form
    {
        ...
        public frmListOfSchedulingApplication(int BranchID)
        {
            InitializeComponent();
            _BranchID = BranchID;
        }
        ...
        {
            frmAddUpdateContractPaymentScheduling frmAddUpdateContractPaymentScheduling = new frmAddUpdateContractPaymentScheduling((int)dgv.CurrentRow.Cells[2].Value,true);
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            frmAddUpdateContractPaymentScheduling.ShowDialog();
            frmListOfSchedulingApplication_Load(null,null);
        }
    }
}
